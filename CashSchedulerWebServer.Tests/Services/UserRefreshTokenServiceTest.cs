...
namespace CashSchedulerWebServer.Tests.Services
{
    public class UserRefreshTokenServiceTest
    {
        ...
        [Fact]
        public async Task Update_ReturnsNewToken()
        {
            ...
            UserRefreshTokenRepository.Setup(r => r.Create(newRefreshToken)).ReturnsAsync(newRefreshToken);
        ...
        public async Task Update_ReturnsUpdatedToken()
        {
            ...
            UserRefreshTokenRepository.Setup(r => r.GetByUserId(TESTING_USER_ID)).Returns(newRefreshToken);
